...
const Projects = () => {
  ...
  const getImageUrl = (path) => {
    ...
    // Admin folder ko strip karke root path nikalne ke liye logic
    const cleanBase = ADMIN_BASE_URL.replace(/\/admin\/?$/, "");
          ...
          >
            ...
            {uniqueCategories.map((cat) => (
              <button
                ...
                className={`py-4 border-b-2 font-bold whitespace-nowrap transition-colors shrink-0 ${activeTab === cat ? "border-primary text-primary" : "border-transparent text-gray-500 hover:text-primary"}`}
              >
                {formatTabLabel(cat)}
              </button>
            ))}
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <Link
                    ...
                    className="inline-block bg-primary hover:bg-[#5a6425] text-white px-5 py-2 rounded font-medium text-sm transition-colors text-center self-start"
                  >
                    View Details
                  </Link>
                </div>
